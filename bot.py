...
DEFAULT_EMBED_DATA = {
    "tarifs_embed": {"title": "[CARTE CADEAUX]", "description": ["📦 AMAZON -72h", "60€ -> 75~120€", "🛒 CARREFOUR -72h", "120€ -> 150~200€", "└ Livraison automatique."], "color_rgb": [255, 192, 203]},
...
def get_next_order_number():
    ...
    if os.path.exists(filename):
        with open(filename, "r") as f:
            try: count = json.load(f).get("count", 0) + 1
            except: count = 1
